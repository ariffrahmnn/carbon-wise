        ...
        <div className="site-footer__grid">
          <div className="site-footer__brand">
            ...
            <div className="site-footer__socials" aria-label="Social media">
              <a href="https://www.instagram.com/h_diqiii?igsh=MTN1bWhtdzV1enhsdg==" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              ...
              <a href="mailto:ashshadiqihasbi@gmail.com" aria-label="Email">
